...
export type MediaGalleryEntryFragment = { __typename?: 'ProductReview', average_rating: number, created_at: string, nickname: string, summary: string, text: string, ratings_breakdown: Array<{ __typename?: 'ProductReviewRating', name: string, value: string } | null> };
...
export const ProductItemFragmentDoc = gql`
  ...
  description {
    ...
    `;
export const MediaGalleryEntryFragmentDoc = gql`
